...
public extension Date {
  ...
  /**
   Checks if self is between input NSDates
     
   - parameter date1: NSDate to compare
   - parameter date2: NSDate to compare
   - returns: True if self is between the input NSDates, false otherwise
  */
  public func isBetween(_ date1: Date, _ date2: Date) -> Bool{
